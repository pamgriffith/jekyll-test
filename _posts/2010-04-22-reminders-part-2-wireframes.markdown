...
<h5>Reminder lists</h5>
<p>[caption id="attachment_340" align="alignnone" width="463" caption="Task list.  Basically the same for current and all tasks.  Tasks with the earliest &quot;due date&quot; appear at the top, color (&amp; text) indicates age."]<a href="http://www.pamgriffith.net/wp-content/2010/04/task_list.png"><img class="size-full wp-image-340  " title="task_list" src="http://www.pamgriffith.net/wp-content/2010/04/task_list.png" alt="Text: -Oldest at the top, color indicates age.  -Finished tasks fade for a moment, then disappear.  -Deleted tasks can be undeleted before they disappear.  -Full description expands.  -All tasks shows finished, recently deleted, and future tasks.  -&quot;All reminders&quot; button opens all reminders list  including future reminders so users can edit them, changes to &quot;current reminders&quot; to come back.  -New reminder lets the user create a new reminder.  -All tasks have checkboxes to &quot;complete&quot; them." width="463" height="843" /></a>[/caption]</p>
...
<h5>Creating and editing reminders</h5>
<p>[caption id="attachment_337" align="alignnone" width="550" caption="The form for creating a reminder.  Users can say what it is, when they need to do it relative to now, how long they should take to do it, whether/how often it repeats, and if they want email alerts."]<a href="http://www.pamgriffith.net/wp-content/2010/04/new_reminder.png"><img class="size-full wp-image-337" title="new_reminder" src="http://www.pamgriffith.net/wp-content/2010/04/new_reminder.png" alt="" width="550" height="710" /></a>[/caption]</p>
