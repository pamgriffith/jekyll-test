...
<p><img src="{{site.base_url}}/uploads/2010/03/buttonstyle.jpg" alt="&quot;Keep reading&quot; button with base style (top), hover style (middle) and active style (bottom) using CSS3" /></p>
...
<p><img src="{{site.base_url}}/uploads/2010/03/textonfloat.jpg" alt="A floated image with text shown in Firefox (left) and Webkit (right). Text on top of the image is circled on the right." /></p>
...
<p><img class="size-full wp-image-224" title="chromebutton" src="{{site.base_url}}/uploads/2010/03/chromebutton1.jpg" alt="The depressed state of the &quot;keep reading&quot; button in Chrome; square corners from the shadow appear outside the rounded button edges." /></p>
...
<p><img src="{{site.base_url}}/uploads/2010/03/chromecorners.jpg" alt="An rgba border in Webkit with dark squares where transparent sides overlap circled in red" /></p>
...
<p>I still wouldn't use HTML5, at least, for any real projects--check out the <a href="{{site.base_url}}/demo/cssoff">page</a> in IE with javascript turned off, ick!  But progressive enhancement with CSS3 rounded corners, box shadow, RGBA, etc. are definitely on the menu.</p>
