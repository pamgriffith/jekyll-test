...
<p><img src="{{site.base_url}}/uploads/2013/02/rtl-margin.png" alt="Wireframe with image on left and text on right" /></a></p>
<p>But the small-screen version had the image below the text:</p>
<p><img src="{{site.base_url}}/uploads/2013/02/rtl-mobile.png" alt="Wireframe of text above an image" /></a></p>
...
<p style="text-align: center;"><a class="demo-popup-link download_button" href="{{site.base_url}}/demo/rtl/rtl-margin.html" rel="demo">demo page</a></p>
